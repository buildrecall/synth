# https://hub.docker.com/repository/docker/buildrecall/windows-cross

# copied from https://jake-shadle.github.io/xwin/#1-install
FROM docker.io/library/rust:1.55.0-slim-bullseye
...
ENV CC_x86_64-pc-windows-msvc="clang-cl" \
...
ENV CFLAGS_x86_64-pc-windows-msvc="$CL_FLAGS" \
    CXXFLAGS_x86_64-pc-windows-msvc="$CL_FLAGS"
